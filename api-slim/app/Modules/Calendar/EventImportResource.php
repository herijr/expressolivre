	...
	public function get($request)
	{
		...
		if (isset($request['event'])) {
			...
			if (is_array($rsVCalendar) && isset($rsVCalendar[0]['contents'])) {
				...
				$description = mb_convert_encoding($description, "ISO-8859-1", mb_detect_encoding($description, "auto"));
				...
				$addEvent['title'] = mb_convert_encoding($addEvent['title'], "ISO-8859-1", mb_detect_encoding($addEvent['title'], "auto"));
