...
<div align="center" id="ccAddGroupContent" style="position: absolute; visibility: hidden">
	...
	<table border="0"  cellpadding="0" cellspacing="0" width="100%">
		<tr height="30">
			...
			<td  valign="center" align="left">&nbsp;&nbsp;{title}</td>
		</tr>
 	</table>			
	<br><br>			
	<table border="0" cellpadding="0" cellspacing="0" width="95%">
		<tr>
			...
			<td id="buttons" width="95" align="center">
				<button type="button" onClick="ccAddGroup.addUser()"><img src="../phpgwapi/templates/celepar/images/add.png" style="vertical-align: middle;" >&nbsp;{txt_add}</button>
				<br><br>
				<button type="button" onClick="ccAddGroup.remUser()"><img src="../phpgwapi/templates/celepar/images/rem.png" style="vertical-align: middle;" >&nbsp;{txt_rem}</button> 
			</td>
			<td  align="left">
				<table border="0" cellpadding="0" cellspacing="0">
					<tr height="30" class="th">
