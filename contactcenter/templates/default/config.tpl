...
<!-- BEGIN body -->
	...
	<tr class="row_off">
		...
		<td>
			<select name="newsettings[cc_ldap_subLevels]">
				...
				<option value="false" {selected_cc_ldap_subLevels_false}>Não</option>
			</select>
		</td>
	</tr>
	<tr class="th">
  ...
  <!-- <tr class="row_on">
	...
	<tr class="th">
		<td colspan="2" align="center"><b>{lang_Extended_search_configuration}:</b></td>
	</tr>
	<tr>
   		<td></td>
	</tr>
	<tr class="row_off">
		<td>{lang_LDAP_attribute_to_search} :</td>
		<td><input name="newsettings[cc_ldap_atrib]" value="{value_cc_ldap_atrib}" size="40" /></td>
	</tr>
	<tr class="row_on">
		<td>{lang_Label} :</td>
		<td><input name="newsettings[cc_ldap_legend]" value="{value_cc_ldap_legend}" size="40" /></td>
	</tr>
