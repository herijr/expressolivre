<?php
  ...
  *  option) any later version.                                               *
  \***************************************************************************/
	...
	$_SESSION['phpgw_info']['user']['preferences']['contactcenter']['personCardEmail'] 	= $actual['personCardEmail'] ? $actual['personCardEmail'] : false;
	$_SESSION['phpgw_info']['user']['preferences']['contactcenter']['personCardPhone']	= $actual['personCardPhone'] ?  $actual['personCardPhone'] : false;
