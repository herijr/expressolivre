	...
	*/
	...
	class bo_ldap_manager 
	{
		...
		*/
		...
		{
			/*
			 * Esta opera��o resolve o problema causado pela convers�o de caracteres acentuados realizada
			 * pela fun��o ldap_explode_dn().
			 */
		...
		function get_ldap_tree_level($id_source, $resource, $context, $objectClass, $branch_dn, $external = 0)
		{
			...
			else
			{
				...
				$context = preg_replace("/dc=(.*)/i",$this->srcs[$id_source]['dn'],$context);	
			}
			...
			*/
			     ...
			     $entry = ldap_next_entry($resource, $entry))
			{
				...
				//Faz a compara��o do branch como case insensitive
