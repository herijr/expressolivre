...
class InfoPersonalResource extends SMSAdapter {
	...
	public function setDocumentation() {
		...
		$this->setResource("SMS","SMS/InfoPersonal","Retorna as informações de SMS do Usuário, último número para qual foi enviado o código de confirmação, os telefones já confirmados pelo usuário, também retorna se o usuário autorizou o envio de SMS para seu celular (SMSAuth) e se o usuário tem permissão de envio de SMS (SendAuth).",array("POST"));
