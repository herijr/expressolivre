					...
					<tbody>
						<tr><td><div class='content-menu'>
							<table border="0" cellspacing="0" cellpadding="0" border="0"><tbody>
								...
								{start_coment_logoff}<tr><td class='content-menu-td' onclick='expresso_offline_access.do_logoff()' onmouseover='javascript:set_menu_bg(this);' onmouseout='javascript:unset_menu_bg(this);'><div class='em_div_sidebox_menu'><img width='18px' height='18px' src='../phpgwapi/templates/default/images/logout.png'><span class="em_sidebox_menu">{logoff}</span></div></td></tr>{end_coment_logoff}
