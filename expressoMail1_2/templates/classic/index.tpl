					...
					<tbody>
						<tr><td><div class='content-menu'>
							<table border="0" cellspacing="0" cellpadding="0" border="0"><tbody>
								<tr><td class='content-menu-td' onclick='javascript:new_message("new","null");' onmouseover='javascript:set_menu_bg(this);' onmouseout='javascript:unset_menu_bg(this);'><div class='em_div_sidebox_menu'><img src='./templates/default/images/menu/createmail.gif'><span class="em_sidebox_menu">{new_message}</span></div></td></tr>
								<tr><td class='content-menu-td' id='em_refresh_button' onclick='javascript:refresh();' onmouseover='javascript:set_menu_bg(this);' onmouseout='javascript:unset_menu_bg(this);'><div class='em_div_sidebox_menu'><img src='./templates/default/images/menu/checkmail.gif'><span class="em_sidebox_menu">{refresh}</span></div></td></tr>
								<tr><td id="link_tools" class='content-menu-td' onmouseover='javascript:set_menu_bg(Element("link_tools"));' onmouseout='javascript:unset_menu_bg(this);'><div class='em_div_sidebox_menu'><img height='16px' src='./templates/default/images/menu/tools.gif'><span class="em_sidebox_menu">{tools} ...</span></div></td></tr>								
							</tbody></table>
						</div></td></tr>
						<tr><td height="2px"></td></tr>						
						<tr><td class="content-folders" valign="top" style="padding:2px">
							<div id="content_folders" style="height:100%;width:170px;overflow:auto"></div>
						</td></tr>
					</tbody>
				</table>
				<div id="search_div" align="center" style="padding-top:4px;white-space:nowrap"> 
					...
					<a class='' onMouseOut="window.status='';return true;" title='{lang_Open_Search_Window}' onMouseOver="window.status='{lang_Open_Search_Window}';return true;" href="javascript:void(0);"  onClick="javascript:search_emails(Element('em_message_search').value)">
						<img valign="center" align="center" src="templates/default/images/search.gif">
					</a>
					<a class='' onMouseOut="window.status='';return true;" title='{lang_search_user}' onMouseOver="window.status='{lang_search_user}' ;return true;" href="javascript:void(0);"  onClick="javascript:emQuickSearch(Element('em_message_search').value, 'null', 'null')">
						<img valign="center" align="center" src="templates/default/images/users.jpg">
					</a>
				</div>
				...
				<div id="exmail_main_body" class="messagescol">
					<table id="border_table" width="auto" height="26" cellspacing="0" cellpadding="0" border="0">
						<tbody id="border_tbody">
							<tr id="border_tr">
								<td nowrap class="menu" onClick="alternate_border(0);resizeWindow();"  id="border_id_0">&nbsp;{lang_inbox}&nbsp;<font face="Verdana" size="1" color="#505050">[<span id="new_m">0</span> / <span id="tot_m">0</span>]</font>
								</td>
