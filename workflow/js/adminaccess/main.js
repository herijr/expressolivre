...
permissionListORG[1]['name'] = "Visualizar Telefone Celular";
permissionListORG[1]['value'] = 1;
permissionListORG[2]['name'] = "Visualizar Telefone Residencial";
permissionListORG[2]['value'] = 2;
permissionListORG[3]['name'] = "Visualizar Matrícula";
permissionListORG[3]['value'] = 3;
permissionListORG[4]['name'] = "Visualizar Cargo";
permissionListORG[4]['value'] = 4;
permissionListORG[5]['name'] = "Visualizar Função";
permissionListORG[5]['value'] = 5;
permissionListORG[6]['name'] = "Visualizar Data Admissão";
permissionListORG[6]['value'] = 6;
