...
<!--//save -->
    ...
    <td bgcolor="#EEEEFF" width="60" valign="top" align="center" nowrap><table width="100%" border="0" cellspacing="8" cellpadding="2">
        ...
        <td width="99%" >
        <iframe width="100%" height="100%" id="editor" name="editor" src="load_image.php?img=<?php echo $image; ?>" marginwidth="0" marginheight="0" align="top" scrolling="auto" frameborder="0" hspace="0" vspace="0" background="gray">
        </iframe>
        </td>
    </tr>
</table>
