...
<tr>
        <td><br><span id="div_msg" class="msg"><?php echo $msg; ?></span></td>
</tr>
<tr>
    <td align="center">
    
    <form action="<?php echo $_PHP_SELF; ?>" method="post" name="frm" id="frm">

    <input type="hidden" name="abaMenu" id="hidden_id_abaMenu" value="<?php echo $abaMenu; ?>"/>
    <input type="hidden" name="acao" id="hidden_id_abaMenu" value="<?php echo $acao; ?>"/>
    <input type="hidden" name="lstoid" id="hidden_id_lstoid" value="<?php echo $lstoid; ?>"/>
        ...
        <table>
            <tr>
                <td align="center" id="tabnav">
                    <a href="javascript:void(null);" onclick="window.location.href='<?php echo $BASE_URL; ?>';" <?php if($abaMenu == 'pesquisa'){ echo 'class="active"'; }?>>Pesquisa</a>
                </td>
