...
/**
 * Check session. When it is a soap access or command line, skip checking the session
 * because it can not be redirected to login page.
 * The constant WF_SKIP_CHECKING_SESSION is defined when a webservice
 * includes this file to build a part of the environment it uses.
 */
if (!defined('WF_SKIP_CHECKING_SESSION') && php_sapi_name() !== 'cli' && file_exists(EGW_SERVER_ROOT . '/header.session.inc.php')) {
