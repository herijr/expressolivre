...
class wf_regex
{
	...
	/**
	 * @var string $TEL_DDI Padrao de validacao de numeros de telefones com DDI (Formato +00 (00) 0000-0000, podendo ter parênteses e/ou hífen, ou não) - adaptado para aceitar telefone com 9 dígitos
	 */
	var $TEL_DDI = '^([+][[:digit:]]{2})?([ (]{1,2}[[:digit:]]{2}[ )]{1,2})?[[:digit:]]{4,5}[ -]?[[:digit:]]{4}$';

	/**
	 * @var string $TEL_DDD Padrao de validacao de numeros de telefones com DDD (Formato (00) 0000-0000) - adaptado para aceitar telefone com 9 dígitos
	 */
	var $TEL_DDD = '^\([[:digit:]]{2}\)\s[[:digit:]]{4,5}-[[:digit:]]{4}$';

	/**
	 * @var string $TEL Padrao de validacao de numeros de telefones (Formato 0000-0000) - adaptado para aceitar telefone com 9 dígitos
	 */
	var $TEL = '^([[:digit:]]{4,5})-([[:digit:]]{4})$';
	 ...
	 */
	var $ADDR_EMAIL = '^([0-9a-zA-Z._-]+)[@]([0-9a-zA-Z-]+\.)+[0-9a-zA-Z]{2,4}$';
