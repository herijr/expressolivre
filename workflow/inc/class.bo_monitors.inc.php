...
class bo_monitors extends bo_ajaxinterface
{
			...
			foreach ($userList as $user => $instances)
			{
				...
				foreach ($instances as $instance)
				{
					...
					$translationArray = array(
						...
						'%tempo_atividade%' => $BOUserInterface->time_diff(time() - $instance['wf_act_started']),
						'%tempo_instancia%' => $BOUserInterface->time_diff(time() - $instance['wf_started']),
	...
	function sendMail($params)
	{
		...
		$profile = Factory::getInstance('bo')->getProfile();
