 ...
 */
class AvailableServersResource extends ExpressoAdapter {

	public function setDocumentation() {

		$this->setResource("Expresso","AvailableServers","Retorna a lista de servidores disponíveis no Ambiente.",array("POST","GET"));
	...
	function get($request){
		...
		{
			$restServers = parse_ini_file(API_DIRECTORY.'/../../config/REST.ini', true );
