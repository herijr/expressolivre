...
class MessagesResource extends MailAdapter {	
	...
	public function setDocumentation() {
		...
		$this->addResourceParam("msgID","integer",false,"ID da mensagem, quando informado retorna uma única mensagem.");
		$this->addResourceParam("search","string",false,"Buscar mensagens com o conteudo.");
		$this->addResourceParam("resultsPerPage","integer",true,"Resultados por página.",true,"10");
		$this->addResourceParam("page","integer",true,"Página Atual.",true,"1");
