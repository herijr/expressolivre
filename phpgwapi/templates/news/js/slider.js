		...
		success:	function(data) {
			...
			$('#slider-dock img')
				...
				.on('mouseout.cycle',function(){
					$('#slider-dock').cycle('resume');
					$('#nav-information-login-control').removeClass('play');
				});
			$('#slider-dock img')
				.off('mouseover.cycle')
				.on('mouseover.cycle',function(){
					$('#slider-dock').cycle('pause');
					$('#nav-information-login-control').addClass('play');
				});
