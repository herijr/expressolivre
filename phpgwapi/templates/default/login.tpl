...
<div align="center">
	<div id="conteudo_corpo">
		<div id="superior">
			<div id="noticias">
					<a href="http://expressolivre.org/ios/"><img src="./phpgwapi/templates/default/images/banner_login.jpg" style="position:relative;float:left;margin-left:-8px"></a>
			</div>
		<div id="login">
	      <div align="center">
			...
			<div id="caixa_login">
          		<div id="reflexo">
            		...
            		<div id="conteudo_login" style="display:{show};">
						...
						{captcha}	     
    		          	<input value="{lang_login}" name="submitit" class="button" onclick="javascript:setLogin()" type="submit" style="margin-top:16px "/>
