		...
		<table align="center" cellspacing="0">
			<tr>
				<td class="row_off">
					{lang_availables} :
					<br/>
					<select id="orgs_availables" size="10" style="width: 300px" multiple>{orgs_availables}</select>
				</td>
				<td class="row_off">
					<input type="button" value="{lang_add}" onclick="SelectBox.swap('orgs_availables','orgs_selecteds');SelectBox.update('orgs_selecteds','my_org_units');" />
					<br/>
					<br/>
					<input type="button" value="{lang_remove}" onclick="SelectBox.swap('orgs_selecteds','orgs_availables');SelectBox.update('orgs_selecteds','my_org_units');" />
				</td>
				<td class="row_off">
					{lang_selecteds} :
					<br/>
					<select id="orgs_selecteds" size="10" style="width: 300px" multiple >{orgs_selecteds}</select>
					<select id="my_org_units" style="display: none;" multiple name="newsettings[my_org_units][]">{orgs_selecteds_hidden}</select>
				</td>
			</tr>
		</table>
		</td>
