...
<!-- BEGIN body -->
	...
	<tr class="row_on">
		<td>{lang_Use_password_generator}?</td>
		<td>
			<select name="newsettings[expressoAdmin_usePasswordGenerator]">
				<option value="false" {selected_expressoAdmin_usePasswordGenerator_false}>{lang_no}</option>
				<option value="true"  {selected_expressoAdmin_usePasswordGenerator_true}>{lang_yes}</option>
			</select>			
		</td>
	</tr>
	...
	<tr class="row_off">
		<td>{lang_Manage_RADIUS_attributes}:</td>
		<td>
			<select name="newsettings[expressoAdmin_radius_support]">
				<option value="false" {selected_expressoAdmin_radius_support_false}>{lang_no}</option>
				<option value="true"  {selected_expressoAdmin_radius_support_true}>{lang_yes}</option>
			</select>			
		</td>
	</tr>
	...
	<tr class="row_off">
		<td>{lang_Raise_user_quota,_to_default,_on_login}:</td>
		<td>
			<select name="newsettings[expressoAdmin_autoRaiseQuota]">
				<option value="false" {selected_expressoAdmin_autoRaiseQuota_false}>{lang_no}</option>
				<option value="true" {selected_expressoAdmin_autoRaiseQuota_true}>{lang_yes}</option>
			</select>
		</td>
	</tr>
	<tr class="row_on">
	...
	<tr class="row_on">
		...
		<td>
			<input name="newsettings[expressoAdmin_allowed_networks]" value="{value_expressoAdmin_allowed_networks}" size="30" />
			({lang_Eg}: 10.0.0.0/8,20.0.0.0/32)
		</td>
	</tr>
