				...
				<table border="0" width=100% cellspacing="4">
					...
					<tr>
						<td width="40%" bgcolor="#DDDDDD">
							...
							<input type="text" id="organization_search" autocomplete="off" size=20 onKeyUp="javascript:search_organization(event, this.value, 'ea_combo_org_info');" onBlur="javascript:sinc_combos_org(context.value, ea_check_allUsers.checked);">
							<br>
							...
							<b>{lang_maillist_users} (<font color=red>{user_count}</font>):</b>
							<button type="button" onClick="javascript:popup_maillist_info();">{lang_text}</button>
							<br>
						...
						<td width="20%" valign="middle" align="center" bgcolor="#DDDDDD">
							<br><br><br><br><br><br>
							<button type="button" onClick="javascript:add_user2maillist();"><img src="expressoAdmin1_2/templates/default/images/add.png" style="vertical-align: middle;" >&nbsp;{lang_add_user}</button>
							<br><br>
							<button type="button" onClick="javascript:remove_user2maillist();"><img src="expressoAdmin1_2/templates/default/images/rem.png" style="vertical-align: middle;" >&nbsp;{lang_remove_user}</button>
						</td>
						
						<td width="40%" valign="bottom" bgcolor="#DDDDDD">
							{lang_search_organization}:<br>
							<input type="text" id="organization_search" autocomplete="off" size=20 onKeyUp="javascript:search_organization(event, this.value, 'ea_combo_org_maillists');" onBlur="javascript:get_available_users(org_context.value, ea_check_allUsers.checked);">
							<br>
							...
							<br>
							<input type="checkbox" name="ea_check_allUsers" id="ea_check_allUsers" onclick="javascript:get_available_users(org_context.value, this.checked);">{lang_show_users_from_all_sub-organizations}.
							<br><br>
							...
							<div style="display:{display_externalEmail_form}">
								<br>
								<b>{lang_external_email}:<b><br>
								<input id="ea_input_externalEmail" size="35" autocomplete="off"><br>
							</div>
						</td>
					</tr>
