...
<table border="0" width="80%" cellspacing="4">
	<tr>
		<td width="35%" bgcolor="#DDDDDD">
			...
			<input type="text" id="organization_search" autocomplete="off" size=20 onKeyUp="javascript:search_organization(event, this.value, 'ea_combo_org');" onBlur="javascript:sinc_combos_org(context.value);">
			<br>
			{lang_organization}:<br>
			<select id="ea_combo_org" name="context" onchange="javascript:sinc_combos_org(this.value);">{manager_organizations}</select><br>
		...
		<td width="35%" valign="bottom" bgcolor="#DDDDDD">
			{lang_search_organization}:<br>
			<input type="text" id="organization_search" autocomplete="off" size=20 onKeyUp="javascript:search_organization(event, this.value, 'ea_combo_org_available_users');" onBlur="javascript:get_available_users(org_context.value);">
			<br>
