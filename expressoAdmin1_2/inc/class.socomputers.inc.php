	...
	*  option) any later version.														 *
	...
	class socomputers
	{
		...
		function write_ldap($dn, $info)
		{
			...
			{
				$this->db_functions->write_log('created computer',$dn);
		...
		function exist_computer_uid($computer_cn, $context)
		{
			// procurar sempre na raiz seguindo 'referral' para nao duplicar
