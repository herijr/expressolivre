...
{hook_passwdhashes}
   ...
   <tr class="th">
    <td colspan="2"><b>{lang_If_using_LDAP_replication}:</b></td>
   </tr>
   
   <tr class="row_on">
    <td>{lang_LDAP_master_host}:</td>
    <td><input name="newsettings[ldap_master_host]" value="{value_ldap_master_host}" size="40"></td>
   </tr>
   
   <tr class="row_on">
    <td>{lang_LDAP_master_rootdn} <b>{lang_(must_have_access_to_write_on_ldap_directory)}:</b></td>
    <td><input name="newsettings[ldap_master_root_dn]" value="{value_ldap_master_root_dn}" size="40"></td>
   </tr>

   <tr class="row_off">
    <td>{lang_LDAP_master_root_password}:</td>
    <td><input name="newsettings[ldap_master_root_pw]" type="password" value="{value_ldap_master_root_pw}"></td>
   </tr>
   ...
   <tr class="row_on">
	...
	<!--
	jakjr: Por enquanto usarei o mesmo usuarios do CC.
   <tr class="th">
    <td colspan="2"><b>{lang_If_using_LDAP_ACL_control_to_split_ldap_tree}:</b></td>
   </tr>

   <tr class="row_on">
    <td>{lang_LDAP_master_whole_host}:</td>
    <td><b>{lang_same_host_from_LDAP_master_host}</b></td>
   </tr>

   <tr class="row_on">
    <td>{lang_LDAP_master_whole_rootdn} <b>{lang_(must_have_access_to_write_on_whole_ldap_directory)}:</b></td>
    <td><input name="newsettings[ldap_master_whole_root_dn]" value="{value_ldap_master_whole_root_dn}" size="40"></td>
   </tr>

   <tr class="row_off">
    <td>{lang_LDAP_master_whole_root_password}:</td>
    <td><input name="newsettings[ldap_master_whole_root_pw]" type="password" value="{value_ldap_master_whole_root_pw}"></td>
   </tr>
